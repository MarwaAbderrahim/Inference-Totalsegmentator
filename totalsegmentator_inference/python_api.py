...
from totalsegmentator_inference.libs import setup_nnunet
from totalsegmentator_inference.config import setup_nnunet, setup_totalseg, increase_prediction_counter, send_usage_stats
...
def totalsegmentator(input, output, ml=False, nr_thr_resamp=1, nr_thr_saving=6,
                     ...
                     force_split=False, output_type="nifti", quiet=False, verbose=False, test=0, onemodel=True):
    """
    ...
    from totalsegmentator_inference.nnunet import nnUNet_predict_image  # this has to be after setting new env vars
